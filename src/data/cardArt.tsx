...
export const CARD_ART: Record<string, () => JSX.Element> = {
  ...
  'card-wisdom': WisdomArt,
  'card-kindness': KindnessArt,
  'card-forgiveness': ForgivenessArt,
  'card-service': ServiceArt,
  'card-humility': HumilityArt,
  'card-patience': PatienceArt,
  'card-integrity': IntegrityArt,
  'card-reflection': ReflectionArt,
  'card-discernment': DiscernmentArt,
  'card-awareness': AwarenessArt,
  'card-generosity': GenerosityArt,
  'card-courage': CourageArt,
  'card-listening': ListeningArt,
  'card-solidarity': SolidarityArt,
  'card-perseverance': PerseveranceArt,
  'card-perspective': PerspectiveArt,
  'card-ren-living': RenLivingArt,
  'card-junzi': JunziArt,
  'card-clear-seeing': ClearSeeingArt,
  'card-week': WeekArt,
  'card-moon': MoonArt,
  'card-constancy': ConstancyArt,
  'card-bridge': BridgeArt,
  'card-horizon': HorizonArt,
  'card-second-walk': SecondWalkArt,
  'card-life-confucius': ConfuciusArt,
  'card-life-mencius': MenciusArt,
  'card-life-laozi': LaoziArt,
  'card-life-socrates': SocratesArt,
  'card-life-ptahhotep': PtahhotepArt,
  'card-life-buddha': BuddhaArt,
  'card-life-jesus': JesusArt,
  'card-life-rumi': RumiArt,
  'card-life-kant': KantArt,
  'card-life-gandhi': GandhiKingArt,
  'card-life-king': KingArt,
};
